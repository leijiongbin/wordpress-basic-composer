...
<div class="v2_banner">
    ...
    <div id="slidershow" class="carousel slide">
        ...
        <div class="carousel-inner">
            <?php
                $terms = get_the_terms($post->ID, 'project_tax');
                ...
                <div class="panel">	
                    ...
                    <div class="collapse navbar-collapse" id="sidebar-v2__list2">
                        <ul class="nav navbar-nav navbar-right" id="collapseTwo">
                            <li class=""><a href="<?php echo of_get_option("of_project_list") ?>">二级栏目</a></li>
                            <?php
                                $terms = get_terms(array('taxonomy' => 'project_tax','hide_empty'=>false,'orderby' => 'menu_order',));    
                ...
                <div class="col-sm-6 showproduct-v2__left">
                    <div class="met_box">
                        <div class="met_imgshowbox showproduct-v2">
                            <div class="my-simple-gallery slides tab-content" data-pswp-uid="1">
                                <?php
                        ...
                        <ul class="nav nav-pills showproduct-v2__list" role="tablist">
                            ...
                            <li class="<?php echo (0 == $key) ? "active" : ""; ?>"><a href="#pro_<?php echo $key; ?>" role="tab" data-toggle="tab">
                                    <img src="<?php echo wp_get_attachment_url($item['post_product_image_gp_small_one'][0]); ?>" alt="" height="70px" width="70px"/>
                                </a>
                            </li>                            
                            <?php endforeach; ?>
                        </ul>
                ...
                <div class="col-sm-6 showproduct-v2__right">
                    <div class="showproduct-v2__para">
                        ...
                        <ul class="v2-list showproduct-v2__para__ul">
                            ...
                            <!-- <li><span>面积</span><?php echo rwmb_meta('post_product_area',null,$post->ID); ?></li>
                            ...
                            <li><span><?php echo rwmb_meta('post_product_title_1',null,$post->ID); ?></span><?php echo rwmb_meta('post_product_1',null,$post->ID); ?></li>
                            <li><span><?php echo rwmb_meta('post_product_title_2',null,$post->ID); ?></span><?php echo rwmb_meta('post_product_2',null,$post->ID); ?></li>
                            <li><span><?php echo rwmb_meta('post_product_title_3',null,$post->ID); ?></span><?php echo rwmb_meta('post_product_3',null,$post->ID); ?></li>

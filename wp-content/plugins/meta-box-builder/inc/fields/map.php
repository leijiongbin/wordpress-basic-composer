...
class MBB_Map extends MBB_Field
{
	...
	public function __construct()
	{
		...
		$this->basic['api_key'] = array(
			'type' => 'text',
			'label' => 'Google Maps API key<span class="required">*</span> (<a href="https://developers.google.com/maps/documentation/javascript/get-api-key" target="_blank">get here</a>)',
		);

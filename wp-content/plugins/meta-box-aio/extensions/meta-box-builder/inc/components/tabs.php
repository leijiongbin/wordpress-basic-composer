<h2 class="nav-tab-wrapper wp-clearfix">
	...
	if ( $tab === 'code' ) {
		?>
		<a href="<?php echo add_query_arg( array( 'tab' => 'fields', 'active' => 'fields' ) ); ?>" class="nav-tab"><?php esc_html_e( 'Fields', 'meta-box-builder' ); ?></a>
		<a href="<?php echo add_query_arg( array( 'tab' => 'fields', 'active' => 'settings' ) ); ?>" class="nav-tab"><?php esc_html_e( 'Settings', 'meta-box-builder' ); ?></a>
		<?php
	} else {
		?>
	...
	<?php if ( ! empty( $this->meta ) ) : ?>
		<a href="<?php echo add_query_arg( 'tab', 'code' ); ?>" class="nav-tab <?php if ( 'code' === $tab ) echo ' nav-tab-active'; ?>"><?php esc_html_e( 'Code', 'meta-box-builder' ); ?></a>
	<?php endif; ?>
</h2>
